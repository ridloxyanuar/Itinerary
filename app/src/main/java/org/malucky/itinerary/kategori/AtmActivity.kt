...
class AtmActivity : BaseActivity(), NearbyViews, NearbyAdapter.OnLocationItemClickListner {
    ...
    override fun onActivityCreated() {
        toolbarATM.setTitle("ATM Terdekat")
...
//        fusedLocationClient = LocationServices.getFusedLocationProviderClient(this)
    ...
    override fun Success(datas: List<ResultsItem?>) {
        ...
        rv_atm.layoutManager = LinearLayoutManager(applicationContext)
