...
import kotlinx.android.synthetic.main.item_list_populer.view.*
...
class PopulerAdapter(data: List<ResultsItem?>, var onClickListener: OnLocationItemClickListner) : RecyclerView.Adapter<PopulerAdapter.MyHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.item_list_populer, parent,false)
...
//
            itemView.tv_populer.text = ambilData.get(position)?.name
